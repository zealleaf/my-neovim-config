return {
	...
	config = function()
		local function on_attach(bufnr)
			...
			vim.keymap.set("n", "<2-LeftMouse>", api.node.open.edit, opts("Open"))
			vim.keymap.set("n", "<CR>", api.node.open.edit, opts("Open"))
			vim.keymap.set("n", "sh", api.node.open.vertical, opts("Open: Vertical Split"))
			vim.keymap.set("n", "sv", api.node.open.horizontal, opts("Open: Horizontal Split"))
			vim.keymap.set("n", "i", api.tree.toggle_gitignore_filter, opts("Toggle Git Ignore"))
			...
			vim.keymap.set("n", "cap", api.fs.copy.absolute_path, opts("Copy Absolute Path"))
